...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(USE_EXPERIMENTAL_ARGUMENT_HAS_BINARY_SCOPE, "Experimental annotation ''{0}'' has binary scope, therefore its usage in @UseExperimental is ignored", TO_STRING);
